...
from form_page import ImportTags2
...
class UserVestListFilter(ChoicesBaseFilter):
    
    title = '筛选马甲'
    parameter_name = 'user_vest'
...
class Tags(GridPage):
    ...
    search_fields = ('tag',)
    list_filter = [UserVestListFilter, ]
    
    form_actions = [ImportTags2]
#     list_filter = ['tag', ('alias',xadmin.filters.BooleanFieldListFilter)]
    ...
    def get_nav_btns(self):
        from form_page import ImportTags
